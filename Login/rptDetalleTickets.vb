...
Public Class rptDetalleTickets
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Login.rptDetalleTickets.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDetalleTickets
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetalleTickets = New rptDetalleTickets()
        rpt.Site = Me.Site
        Return rpt
    End Function

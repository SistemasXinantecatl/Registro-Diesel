...
Public Class rptResumenTickets
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Login.rptResumenTickets.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResumenTickets
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResumenTickets = New rptResumenTickets()
        rpt.Site = Me.Site
        Return rpt
    End Function

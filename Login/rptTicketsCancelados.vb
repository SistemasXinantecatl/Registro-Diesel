...
Public Class rptTicketsCancelados
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptTicketsCancelados.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Login.rptTicketsCancelados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTicketsCancelados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTicketsCancelados = New rptTicketsCancelados()
        rpt.Site = Me.Site
        Return rpt
    End Function
